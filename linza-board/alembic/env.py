...
Reads DATABASE_URL from environment (same var as the application).
Imports all SQLAlchemy models via backend.models so autogenerate
...
# both when running `alembic` CLI and from application code.
